    ...
    return (
        <div className="shrink overflow-auto">
            ...
            <tr className="text-sm border-b">
                ...
                <th className="p-4 font-normal flex justify-center h-full"><p className="bg-gradient-to-r from-lime-500 to-green-600 rounded-[10px] text-white w-20 h-7 flex justify-center items-center">ONLINE</p></th>
            ...
            <tr className="text-sm border-b text-left">
                ...
                <th className="p-4 font-normal flex justify-center items-center"><p className="bg-gradient-to-r from-lime-500 to-green-600 rounded-[10px] text-white w-20 h-7 flex justify-center items-center">ONLINE</p></th>
